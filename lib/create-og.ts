...
export const createOgImage = ({
  ...
  [
    ...
    `l_text:Karla_72_bold:${e(title)},co_rgb:BDAE93,c_fit,w_1400,h_240`,
    // Positioning
    `fl_layer_apply,g_south_west,x_100,y_180`,

    // META
    // Karla, but smaller
    `l_text:Karla_48:${e(meta)},co_rgb:cccccc,c_fit,w_1400`,
    // Positioning
    ...
    // BG
    `v1734540153/grain-gradient.png`, // public id instead of folder or file names
  ].join("/");
